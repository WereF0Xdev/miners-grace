...
public class MetalDetectorStageTwoItem extends Item {
    public MetalDetectorStageTwoItem(Settings settings) {
        super(settings);
    }
    ...
    private boolean IsValuableBlock(BlockState state) {
        return state.isIn(ModTags.Blocks.METAL_DETECTOR_STAGE_TWO_DETECTABLE_BLOCKS);
    }

    @Override
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.miners-grace.metal_detector.tooltip"));
        tooltip.add(Text.translatable("tooltip.miners-grace.metal_detector_stage_two.tooltip"));
